    ...
    <div className="max-w-7xl mx-auto px-4">
      <div ref={containerRef} className="opacity-0 animate-fade-in-up animation-delay-300">
        <div className="flex items-center gap-4 mb-16">
          ...
          <h2 className="font-SFMono text-4xl font-bold text-lightest-slate">Sobre Mim</h2>
        ...
        <div className="grid lg:grid-cols-3 gap-16 items-start">
          ...
          >
            ...
            <div className="mt-12 pl-8">
              <h3 className="text-2xl font-semibold mb-6" style={{ color: '#a8b2d1' }}>
              ...
              <div className="space-y-6">
                <div className="relative pl-8">
                  ...
                  ></div>
                  <div className="absolute left-1.5 top-5 w-0.5 h-full" style={{ backgroundColor: '#233554' }}></div>
                  <div>
                    <h4 className="font-semibold" style={{ color: '#ccd6f6' }}>
                      Desenvolvedor Front-end
                    </h4>
                    <p className="text-sm font-medium" style={{ color: '#64ffda' }}>
                      Otther Company / FHEMIG • Abr/2025 – Atual
                    </p>
                    <p className="text-sm mt-2 leading-relaxed" style={{ color: '#8892b0' }}>
                      Entreguei 7 módulos de dashboard em 3 meses usando React e Chakra UI. Desenvolvi 2 módulos
                      críticos em 1 semana com zero retornos do QA.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative pl-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-2 leading-relaxed" style={{ color: '#8892b0' }}>
                      Referência técnica no gateway de pagamentos v2. Implementei APIs com Fastify/MongoDB, otimizando
                      latência de 200ms para 120ms. Mentorei 3 devs juniores.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative pl-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-2 leading-relaxed" style={{ color: '#8892b0' }}>
                      Plataforma de aprendizado com Next.js, Tailwind CSS e validações avançadas. Integração com APIs
                      REST e WebSocket para progresso em tempo real.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative pl-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-2 leading-relaxed" style={{ color: '#8892b0' }}>
                      Painel admin web + app React Native. Implementei autenticação com cookies e React Query. CI/CD no
                      Azure DevOps com deployments diários.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Technologies */}
          <div ref={techRef} className="w-full opacity-0 lg:translate-x-[50px] transition-all duration-700">
            <h3 className="text-3xl font-bold mb-8 text-center" style={{ color: '#a8b2d1' }}>
              Tecnologias
            </h3>
                ...
                <div className="w-full grid grid-cols-2 gap-3 relative z-10">
                  {technologies.frontend.map((tech, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium" style={{ color: '#a8b2d1' }}>
                        {tech.name}
                      </span>
                    </div>
                  ))}
